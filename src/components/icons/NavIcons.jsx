...
export function DabangLogo() {
  return (
    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#4880FF]">
      <svg className="h-5 w-5 text-white" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C8.5 2 6 4.5 6 8c0 2.2 1.2 4.1 3 5.2V22l3-2 3 2v-8.8c1.8-1.1 3-3 3-5.2 0-3.5-2.5-6-6-6zm0 2c2.2 0 4 1.8 4 4s-1.8 4-4 4-4-1.8-4-4 1.8-4 4-4z" />
      </svg>
    </div>
  )
}
